...
var ms = Metalsmith(__dirname) // the working directory
    ...
    .source('./html/international-toolkit')     // the page source directory
    ...
    .use(fileMetadata([
        {
            pattern: "**",
            metadata: {"library": "international-toolkit"}
        },
        {
            pattern: "*",
    ...
    .destination('../library/international-toolkit')   // the destination directory
